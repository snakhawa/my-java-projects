 ...
 * 1. Given an array of integers, find if the array contains any duplicates - Using HashSet and Sort
 * 2. Given an array of duplicates find single non duplicate number- Using Hashset, Sort and compare and XOR solution
